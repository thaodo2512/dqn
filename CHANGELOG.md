...
## [0.2.3] - 2024-07-19
### Fixed
- Updated Jetson Docker image to install `freqtrade[all]==2023.8` (Python 3.8 compatible) and compile TA-Lib from source with refreshed `config.guess/config.sub` scripts.
